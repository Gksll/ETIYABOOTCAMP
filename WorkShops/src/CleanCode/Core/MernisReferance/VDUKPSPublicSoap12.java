...
public class VDUKPSPublicSoap12
{
    ...
    {
        VDUExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws Exception;

        Object ProcessResult(VDUExtendedSoapSerializationEnvelope __envelope, Object result) throws Exception;
    }
    ...
    protected List sendRequest(String methodName, VDUExtendedSoapSerializationEnvelope envelope, Transport transport , com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws Exception
    {
    ...
    Object getResult(Class destObj, Object source, String resultName, VDUExtendedSoapSerializationEnvelope __envelope) throws Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws Exception
    {
        ...
        return (Boolean)execute(new VDUIWcfMethod()
        {
            ...
            @Override
            public Object ProcessResult(VDUExtendedSoapSerializationEnvelope __envelope, Object __result)throws Exception {
    ...
    protected Object execute(VDUIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws Exception
    {
    ...
    protected Exception convertToException(org.ksoap2.SoapFault fault, VDUExtendedSoapSerializationEnvelope envelope)
    {
