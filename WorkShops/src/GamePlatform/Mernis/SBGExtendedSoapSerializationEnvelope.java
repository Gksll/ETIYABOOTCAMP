...
public class SBGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SBGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SBGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SBGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SBGDateTimeConverter dateTimeConverter = new SBGStandardDateTimeConverter();

    public SBGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SBGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SBGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SBGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SBGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SBGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
