...
public class SBGKPSPublicSoap
{
    ...
    public SBGKPSPublicSoap(){}

    public SBGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SBGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SBGExtendedSoapSerializationEnvelope envelope= new SBGExtendedSoapSerializationEnvelope(SBGExtendedSoapSerializationEnvelope.VER11);
