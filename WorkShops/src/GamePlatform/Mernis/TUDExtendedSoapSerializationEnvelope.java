...
public class TUDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TUDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TUDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TUDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TUDDateTimeConverter dateTimeConverter = new TUDStandardDateTimeConverter();

    public TUDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TUDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TUDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TUDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TUDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TUDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
