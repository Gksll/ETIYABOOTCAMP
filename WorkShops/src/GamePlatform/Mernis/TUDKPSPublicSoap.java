...
public class TUDKPSPublicSoap
{
    ...
    public TUDKPSPublicSoap(){}

    public TUDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TUDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TUDExtendedSoapSerializationEnvelope envelope= new TUDExtendedSoapSerializationEnvelope(TUDExtendedSoapSerializationEnvelope.VER11);
