...
public class VDUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VDUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VDUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VDUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VDUDateTimeConverter dateTimeConverter = new VDUStandardDateTimeConverter();

    public VDUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VDUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VDUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VDUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VDUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VDUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
