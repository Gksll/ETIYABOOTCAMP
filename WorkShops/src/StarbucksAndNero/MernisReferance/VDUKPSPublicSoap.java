...
public class VDUKPSPublicSoap
{
    ...
    public VDUKPSPublicSoap(){}

    public VDUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VDUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VDUExtendedSoapSerializationEnvelope envelope= new VDUExtendedSoapSerializationEnvelope(VDUExtendedSoapSerializationEnvelope.VER11);
